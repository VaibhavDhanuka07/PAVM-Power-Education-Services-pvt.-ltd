...
course_data as (
  select * from (values
    ...
    ('B.Com.', 'bcom-distance', 'banking-finance', '3 years', 'Distance B.Com. program focused on accounting, commerce, and business fundamentals.'),
    ...
    ('M.A. English', 'ma-english-distance', 'language-studies', '2 years', 'Distance M.A. English program with literature and language specialization.'),
    ('M.A. Sociology', 'ma-sociology-distance', 'language-studies', '2 years', 'Distance M.A. Sociology program focused on social systems and research methods.'),
    ('M.A. Political Science', 'ma-political-science-distance', 'management', '2 years', 'Distance M.A. Political Science program in governance and political thought.'),
    ('M.A. History', 'ma-history-distance', 'language-studies', '2 years', 'Distance M.A. History program with historical methods and interpretation.'),
    ('M.A. Economics', 'ma-economics-distance', 'banking-finance', '2 years', 'Distance M.A. Economics program in policy, macroeconomics, and analytics.'),
    ('M.Com.', 'mcom-distance', 'banking-finance', '2 years', 'Distance M.Com. program in accounting, finance, and commerce strategy.'),
    ('M.Sc. Mathematics', 'msc-mathematics-distance', 'mathematics', '2 years', 'Distance M.Sc. Mathematics program with pure and applied mathematics.'),
